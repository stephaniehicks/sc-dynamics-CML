...
biomaRt::getBM(attributes = c("hgnc_symbol", "ensembl_gene_id"), mart = mart,
                    filters = "hgnc_symbol", values = as.character(rowData(sce)$gene_name))
...
```{r}
grep("E2F4", rownames(sce)) # 3966
hist(counts(sce)[3966, ])
```
