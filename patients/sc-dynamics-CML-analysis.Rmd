...
Test distribution difference between 199 cancer and 635normal cells. We used DESCEND to test for differences in nonzero fraction, nonzero intensity, mean, coefficient of variance, and Gini coefficient between cancer cells and normal cells.
```{r}
